...
```{r modele2}
# Modèle ANCOVA
otters_lm4 <- lm(data = otters_tool,total_prey~tool_use*sex+hardness,subset=tool_use>10)
...
otters_glm2 <- glm(data = otters_tool, Epreycalc ~ hardness + tool_use + age, family = quasipoisson)
