...
\(5\) Les escargots ne sont pas les plus durs mais suscitent une utilisation très fréquente d'outils.
...
```{r regression2}
otters_lm2 <- lm(data = otters_tool, tool_use ~ hardness * prey + 0)
# résumé du modèle
tabularise(summary_(otters_lm2))
#équation paramétrée
eq_(otters_lm2)
#graphiques des résidus
