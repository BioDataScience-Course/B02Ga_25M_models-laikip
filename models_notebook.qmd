...
# Les proies dures contiennent plus de calories ?
...
Les résultats montrent que les femelles utilisent les outils plus fréquemment que les mâles.
...
```{r regression2}
otters_lm2 <- lm(data = otters_tool, lg_Tool ~ snail_num)
# résumé du modèle
