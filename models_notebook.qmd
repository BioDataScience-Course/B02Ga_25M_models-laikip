...
-   le modèle 4 (GLM) semble le plus intéressant : le modèle reprenant l'influence de l'usage d'outil et l'âge de l'individu pour expliquer l'apport calorifique total en fonction de la dureté de la proie semble être intéressant, il respecte la condition initiale de non-normalité de la distribution
