...
chart(otters_tool, length ~ dietT %fill=% sex) + 
  geom_boxplot()
chart(otters_tool, length ~ area %fill=% sex) + 
  geom_boxplot()
chart(otters_tool, ~ length %fill=% ageclass) + geom_histogram(bins = 40)

chart(otters_tool, ~ length %fill=% sex | area) + geom_histogram(bins = 30)

chart(otters_tool, ~ mass %fill=% sex) + geom_histogram(bins = 40)
```
